...
<body>
    ...
    <div id="background"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 612 739">
            <polygon points="0 0 612 0 0 739 0 0" style="fill:#333;" />
        </svg>
    </div>
    ...
    <div id="todo">
        <div id="add">
            <form method="POST" class="formtodo" action="add_query.php">
                <div id="submit">
                    <input type="text" class="addtodo" maxlength="200" name="task" placeholder="Add new task"
                        required />
